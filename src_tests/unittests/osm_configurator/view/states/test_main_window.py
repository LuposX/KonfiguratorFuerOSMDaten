...
import src_tests.manualtests.osm_configurator.view.controller_stub.category_controller_stub as \
...
import src_tests.manualtests.osm_configurator.view.controller_stub.settings_controller_stub as \
    settings_controller_stub_i
import src_tests.manualtests.osm_configurator.view.controller_stub.aggregation_controller_stub as \
    aggregation_controller_stub_i
import src_tests.manualtests.osm_configurator.view.controller_stub.calculation_controller_stub as \
...
import src_tests.manualtests.osm_configurator.view.controller_stub.data_visualization_controller_stub as \
    data_visualization_controller_stub_i
import src_tests.manualtests.osm_configurator.view.controller_stub.osm_data_controller_stub as \
...
def test_innit():
    ...
    main_window: main_window_i.MainWindow = main_window_i.MainWindow(
    ...
    # No assert, since we only test for a crash
