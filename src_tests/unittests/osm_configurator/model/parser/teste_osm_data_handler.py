...
def test_osm_data_handler():
    ...
    osm_data_handler.apply_file(os.path.join(TEST_DIR, "data/monaco_split_up_files/0_super_traffic_cell.pbf"))
    ...
    osm_data_handler.apply_file(os.path.join(TEST_DIR, "data/monaco_split_up_files/1_the_funny_cat.pbf"))
