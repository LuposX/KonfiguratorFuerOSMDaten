...
def _parse_the_data(aggregation_method: AggregationMethod,
...
class AggregationPhase(ICalculationPhase):
    ...
    def calculate(self, configuration_manager_o: ConfigurationManager,
        ...
        Args:
            configuration_manager_o (configuration_manager.ConfigurationManager): The object containing all
                the configuration needed for execution.
            application_manager (ApplicationSettings): The settings of the application

        Returns:
            calculation_state_enum.CalculationState: The state of the calculation,
                after this phase finished its execution or failed trying so.
        """
        ...
        active_aggregation_methods: List[AggregationMethod] = \
            aggregation_configuration.get_all_active_aggregation_methods()
