...
import src.osm_configurator.model.application.application_settings_enum as application_settings_enum_i

if TYPE_CHECKING:
    from pathlib import Path
    from src.osm_configurator.model.application.application_settings_enum import ApplicationSettingsEnum
...
def create_application_settings_file(saving_path: Path, application_settings_file_name: str) -> bool:
    """
    ...
    setting: ApplicationSettingsEnum
    for setting in application_settings_enum_i.ApplicationSettingsEnum:
...
class ApplicationSettings:
    ...
    def get_setting(self, settings_enum: ApplicationSettingsEnum) -> str | None:
        """
        This method gets a specific setting from the setting file.

        Args:
            settings_enum (ApplicationSettingsEnum): The setting we want to get.
    ...
    def set_setting(self, settings_enum: ApplicationSettingsEnum, setting_value: str) -> bool:
        """
        This method sets a setting in the setting file.

        Args:
            settings_enum (ApplicationSettingsEnum): The setting we want to set.
