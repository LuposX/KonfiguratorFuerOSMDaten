...
class IProjectController(ABC):
    ...
    def delete_passive_project(self, passive_project: PassiveProject) -> bool:
        ...
        Returns:
            bool: True, if the (passive) project has been deleted successfully; False otherwise:
                The project does not exist or the application has not the right permissions to delete the project.
        """
        pass
