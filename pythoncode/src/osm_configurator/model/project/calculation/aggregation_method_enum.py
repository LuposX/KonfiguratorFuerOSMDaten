...
from src.osm_configurator.model.project.configuration.attractivity_attribute import AttractivityAttribution
...
def _average(data, attractivity):
    pass
...
class AggregationMethod(Enum):
    ...
    Whereby an aggregation methods, a method is that takes in data and an attractivity attribute and outputs
