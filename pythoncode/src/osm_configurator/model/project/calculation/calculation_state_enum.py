...
class CalculationState(Enum):
    ...
    ERROR_INVALID_PREVIOUS_CALCULATIONS = "Error, this calculation phase can not be calculated, because a previous calculation has invalid results or wasn't run"
