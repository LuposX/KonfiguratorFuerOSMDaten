...
class AggregationPhase(ICalculationPhase):
    ...
    def calculate(self, configuration_manager):
        ...
        The calculation phase reads the data of the previous calculation phase. Now for every traffic cell, every attractivity attribute and every aggregation method selected, the aggregation method is performed on the traffic cell with the attractivity attribute. For details on the different aggregation methods, see AggregationMethod.
