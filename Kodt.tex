...
\subsubsection*{Darstellen der Berechnungsergebnisse <A17>}
...
\subsubsection*{Abbrechen der Berechnung/Neuberechnung <A18>}
\textbf{Anwendungsfall:}  Der Nutzer befindet sich gerade in der Berechnung/Oder die Berechnung wurde gerade abgeschlossen.\\\\
\textbf{Anforderungen:} \\\\
\textbf{Ziel:} Die Berechnung abzubrechen neuzustarten.\\\\
\textbf{Vorbedingung:} Der Nutzer befindet sich auf der Berechnungsseite und berechnet etwas oder ist fertig mit der Berechnung.\\\\
\textbf{Nachbedingung Erfolg:} Der Nutzer kann erneut auswählen was berechnet werden soll und die Berechnung starten.\\\\
\textbf{Auslösendes Ereignis:} Der Nutzer drückt den 'cancel' Knopf während der Berechnung doer den 'Recalculate' Knopf am Ende der Berechnung.\\\\
\textbf{Beschreibung:}
\begin{enumerate}
    \item Die Berechnung wird abgebrochen.
    \item Die Berechnungs-Seite wird auf seine Startposition zurückgesetzt.
\end{enumerate}
\textbf{Alternative:}
\begin{itemize}
    \item 1a: Die Berechnung ist schon fertig und muss nicht abgebrochen werden.
\end{itemize}
\newpage
